...
## Intro
This repo is a clone from the project [nextjs-notion-starter-kit](https://github.com/transitive-bullshit/nextjs-notion-starter-kit). All credits, go to him.

I changed it as my perosnal website.
